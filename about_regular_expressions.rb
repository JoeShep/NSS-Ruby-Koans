...
class AboutRegularExpressions < EdgeCase::Koan
  ...
  #
  # Why? Joe Adds: Because they grab every instance they can.
  ...
  # Explain the difference between a character class ([...]) and alternation (|).
      # Joe adds: I believe the difference is: A character class compares the string to all the included characters at the same time, whereas an alternation
      # acts like a loop, checking one, then checking the next if no success, and so on. I have read that generally charcter classes are considered
