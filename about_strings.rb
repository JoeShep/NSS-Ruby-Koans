...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # Joe adds :  Because (<<) doesn't create a new object every time. It builds on the same object, 
    # preserving the ID, which runs faster.
  end
  ...
  def test_you_can_get_a_single_character_from_a_string
    ...
    # Surprised? Joe adds: Yup. In 2.0.0 the answer is "a".
  end
